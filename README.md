...
- **Họ và tên**: LÊ ĐĂNG HÙNG

- **Mã lớp**: DK24TTC4  

- **MSSV**: 170124469

- **Email**: hungjakale@gmail.com

- **Số điện thoại**: 0377877424 
...
## Cách cài đặt
   ...
   2. Lấy mã nguồn
    ...
    - Hoặc Terminal: cd ASPNET-DK24TTC4-LeDangHung-QLSanBongDaMini\SRC
...
{
  "ConnectionStrings": {
    "DefaultConnection": "Server=(localdb)\\MSSQLLocalDB;Database=QLSanBong_LeDangHung;Trusted_Connection=True;MultipleActiveResultSets=true"
  }
}
```
...
{
  "ConnectionStrings": {
    "DefaultConnection": "Server=.\\SQLEXPRESS;Database=QLSanBong_LeDangHung;Trusted_Connection=True;TrustServerCertificate=True;MultipleActiveResultSets=true"
  }
}
```
...
{
  "ConnectionStrings": {
    "DefaultConnection": "Server=SERVERNAME;Database=QLSanBong_LeDangHung;User Id=sa;Password=your_password;TrustServerCertificate=True;MultipleActiveResultSets=true"
  }
}
```
   ...
   6. Script tự động hoá (Windows PowerShell)
     ...
     ```powershell
       param(
         ...
         [string]$Database = "QLSanBong_LeDangHung",
         [string]$User = "",
         [string]$Password = "",
...
./scripts/setup.ps1 -ProjectPath ./SRC -SqlServer "(localdb)\MSSQLLocalDB" -Database QLSanBong_LeDangHung -UseWindowsAuth -Run

# Hoặc dùng tài khoản SQL
./scripts/setup.ps1 -ProjectPath ./SRC -SqlServer ".\SQLEXPRESS" -Database QLSanBong_LeDangHung -User sa -Password "your_password" -Run
```
